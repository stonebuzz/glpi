...
class Notification extends CommonDBTM {
   ...
   **/
   ...
   function getSpecificMassiveActions($checkitem = null) {
      ...
      $actions[__CLASS__.MassiveAction::CLASS_ACTION_SEPARATOR.'remove_all_template'] = _x('button', 'Remove all notification template');
            ...
            foreach ($ids as $id) {
               ...
               if($notification_template->fields['itemtype'] == $notification->fields['itemtype']){
                  ...
                  if($notification_notificationtemplate->getFromDBByCrit($data)){
                     ...
                     $ma->addMessage($notification_template->getErrorMessage(ERROR_ALREADY_DEFINED)." (".$notification->getLink().")");
