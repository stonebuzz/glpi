...
editor.on('drop', function(e) {
    ...
    if (dataTransfer && dataTransfer.files && dataTransfer.files.length > 0) {
        ...
        for (var i = 0 ; i < files.length ; i++) {
            ...
            upload += '[** UPLOADING FILE ==> '+files[i].name+' **]<br>';
        ...
        //Create formdata objet to upload object as file on ajx request
        var fd = new FormData(); 
        for (var i = 0; i < files.length; i++) { 
        ...
        $res = uploadFile(fd,editor);

        //editor.execCommand('mceReplaceContent',false, upload);
...
editor.on('PastePreProcess', function(e) {
    ...
    if(isImage(content)){
        ...
        upload += '[** UPLOADING FILE ==> '+filename+' **]<br>';
        editor.execCommand('mceInsertContent',false, upload);
...
function uploadFile(fd,editor,item_type = '', item_id = ''){ // upload function

 // The last append is the number of files
